...
function parseDate (name) {
  ...
  // Sequential number format (e.g. 01-, 02-) - use number for ordering
  var seqMatch = name.match(/(\d{2,14})-[^.]+/);
  if (seqMatch) {
    date.setTime(parseInt(seqMatch[1], 10) * 86400000);
    return date;
  }
  return date;
}
